...
function magicMouse(options) {
  ...
  if (!Modernizr.touchevents){
    ...
    document.addEventListener("contextmenu", e => {
      e.preventDefault();
      if(inNews == true){
        pointerDOM.style.height="40px";
        pointerDOM.style.width="80px";
        pointerDOM.style.borderRadius="45%";
        pointerDOM.style.background="#ff0558";
      }
    });
    ...
    document.addEventListener("mouseup", event => {
      pointerDOM.style.width="5px";
      pointerDOM.style.height="5px";
    });
    //Hover effects :
